...
日期：2026-09-19　硬體：W6300-EVB-Pico2 + SparkFun MLX90640 Qwiic（板載上拉，阻值未知）
...
- 現況：SDA／SCL 上升時間約 220 ns（τ≈260 ns），Fast-mode Plus 規格上限 120 ns。原因是 SparkFun 模組上的上拉（兩側各 4.7 kΩ，經 BSS138 電位轉換）對目前的線路電容太弱。
